        ...
        <div class="row align-items-center center rounded m-2" style="background-color: #A4907C;" alt="mempelai"
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="row align-items-center center rounded m-2" style="background-color: #A4907C;" @if
                    ...
                    <div class="col-12 col-md-4">
                        <h1 class="fs-3" style="color: #eaeaea;" @if (in_array('Animasi',$fitur))
                            data-aos="zoom-in-down" @endif>{{ $pesan->mPria->nama_pria }}</h1>
                        <br>
                        <p style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down" @endif>
                            Anak Ke-{{
                    ...
                    <div class="col-12 col-md-4">
                        <h1 class="fs-3" style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up"
                            @endif>
                            <<<<<<< HEAD {{ $pesan->mWanita->nama_wanita_lengkap }}
                                =======
                                {{ $pesan->mWanita->nama_wanita }}
                                >>>>>>> 84df7f9 (Change Layout Account User page & Fix Some Bug)
                        </h1><br>
                        <p style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif>
                            Anak Ke-{{
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <img src="{{ asset('img/arta/BOX11444.JPG') }}" class="shadow-lg p-2 mb-5 bg-body rounded"
                                width="200px" height="320px" @if (in_array('Animasi',$fitur)) data-aos="fade-down"
                                @endif>
                        </div>
                        <div class="col">
                        ...
                        <div class="col-sm-6">
                            <div class="card" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif>
                                <div class="card-body">
                                    ...
                                    @if (in_array('Lokasi Acara Maps', $fitur))<iframe
                                        src="{{ $pesan->data->iframeMaps_akad}}" width="400" height="300"
                        ...
                        <div class="col-sm-6">
                            <div class="card" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down" @endif>
                                <div class="card-body">
                                    ...
                                    @if (in_array('Lokasi Acara Maps', $fitur))<iframe
                                        src="{{ $pesan->data->iframeMaps_resepsi}}" width="400" height="300"
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <form id="greetingForm">
                                <h2 class="card-text" @if (in_array('Animasi',$fitur)) data-aos="zoom-in" @endif>
                                    Kartu Ucapan
                                </h2>
                        ...
                        <div class="card-footer text-muted">
                            <div id="senderInfo" class="sender-info" @if (in_array('Animasi',$fitur)) data-aos="fade-up"
                                @endif>
                            </div>
            ...
            <footer class="center shadow p-3 m-4 bg-body rounded"
                style="font-family: 'Parisienne', cursive; color: #A4907C;" @if (in_array('Animasi',$fitur))
                ...
                <p @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif class="fs-5">Merupakan Suatu
                    Kebahagian dan
