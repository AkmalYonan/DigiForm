...
<body class="background-utama">
    ...
    <div class="shadow p-4 m-4 bg-body rounded" id="mempelai">
        <h3 class="text-mempelai display-5 mb-4" style="font-family: 'Parisienne', cursive;" @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif>Sang
            Mempelai
        </h3>
        <div class="row align-items-center center rounded m-2" style="background-color: #A4907C;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down" @endif>
            <div class="col-12 col-md-4">
                <h1 class="fs-3" style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down" @endif>{{ $pesan->mPria->nama_pria }}</h1>
                <br>
                <p style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down" @endif>Anak Ke-{{ $pesan->mPria->anak_ke }} Dari Pasangan
            ...
            <div class="col-12 col-md-4">
                <h1 class="fs-3" style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif>{{ $pesan->mWanita->nama_wanita }}
                </h1><br>
                <p style="color: #eaeaea;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif>Anak Ke-{{ $pesan->mWanita->anak_ke }} Dari Pasangan
    ...
    <main class="m-4 ">
        <section id="gallery" class="center">
            ...
            <h2 class="text-foto display-4  mb-4" style="font-family: 'Parisienne', cursive;" @if (in_array('Animasi',$fitur)) data-aos="fade-down" @endif>
                Galeri
                Foto</h2>
            <div class="row">
                <div class="col">
                    <img src="{{ asset('img/arta/BOX11442.JPG') }}" class="shadow-lg p-2 mb-5 bg-body rounded" width="200px" height="320px" @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif>
                </div>
                <div class="col">
                    <img src="{{ asset('img/arta/BOX11444.JPG') }}" class="shadow-lg p-2 mb-5 bg-body rounded" width="200px" height="320px" @if (in_array('Animasi',$fitur)) data-aos="fade-down" @endif>
                </div>
                <div class="col">
                    <img src="{{ asset('img/arta/BOX11445.JPG') }}" class="shadow-lg p-2 mb-5 bg-body rounded" width="200px" height="320px" @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif>
                </div>
                <div class="col">
                    <img src="{{ asset('img/arta/BOX11447.JPG') }}" class="shadow-lg p-2 mb-5 bg-body rounded" width="200px" height="320px" @if (in_array('Animasi',$fitur)) data-aos="fade-down" @endif>
                </div>
                <div class="col">
                    <img src="{{ asset('img/arta/BOX11440.JPG') }}" class="shadow-lg p-2 mb-5 bg-body rounded" width="200px" height="320px" @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif>
                </div>
            </div>
            @endif
            <div class="shadow p-3 mb-5 bg-body rounded" @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif>
        ...
        <section id="details" class="center shadow p-3 mb-5 bg-body rounded">
            <h2 class="text-acara display-4" style="font-family: 'Parisienne', cursive;" @if (in_array('Animasi',$fitur)) data-aos="zoom-in" @endif>Detail
                Acara
            </h2>
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif>
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $pesan->data->tgl_akad }}<br>{{ $pesan->data->jam_acara }}
                            </p>
                            <p class="card-text">{{ $pesan->data->lokasi_acara }}<br>{{ $pesan->data->lokasi_acara }}
                            </p>
                ...
                <div class="col-sm-6">
                    <div class="card" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down" @endif>
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $pesan->data->tgl_resepsi }}<br>{{ $pesan->data->jam_acara }}
                            </p>
                            <p class="card-text">{{ $pesan->data->lokasi_acara }}<br>{{ $pesan->data->lokasi_acara }}
                            </p>
                            @if (in_array('Lokasi Acara Maps', $fitur))
        ...
        <section id="rsvp">
            <div class="card text-center">
                <div class="card-header">
                    <p @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif class="fs-1 text-acara" style="font-family: 'Parisienne', cursive;">
                        Konfirmasi
                        Kehadiran</p>
                </div>
                <div class="card-body">
                    <form id="greetingForm">
                        <h2 class="card-text" @if (in_array('Animasi',$fitur)) data-aos="zoom-in" @endif>Kartu Ucapan</h2>
                        ...
                        <button @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif type="submit" id="btn-coklat" class="btn btn-primary mt-3">Kirim Kartu
                            Ucapan</button>
                    </form>
                </div>
    ...
    <footer class="center shadow p-3 m-4 bg-body rounded" style="font-family: 'Parisienne', cursive; color: #A4907C;" @if (in_array('Animasi',$fitur)) data-aos="fade-up" @endif>
        <button id="playPauseButton" class="play">
            <i class="fas fa-music"></i>
        </button>
        <h1 @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif>Terimakasih</h1>
        <p @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up" @endif class="fs-5">Merupakan Suatu Kebahagian dan Kehormatan bagi kami. Apabila
