        ...
        <section class="bg-img">
            <div class="isi">
                <div class="isi2">
                    ...
                    <h1>{{ $pesan->mPria->nama_pria }}</h1>
                    <p>Putra dari Bapak {{ $pesan->mPria->nama_ayah }} & Ibu {{ $pesan->mPria->nama_ibu }}
                    <h1 style="font-weight: bold; font-size: 55px; font-family: 'Alex Brush', cursive; color: CFB975;">&
                    </h1>
                    </p>
                    <h1>{{ $pesan->mWanita->nama_wanita }}</h1>
                    <p>Putri dari Bapak {{ $pesan->mWanita->nama_ayah }} & Ibu {{ $pesan->mWanita->nama_ibu }}</p>
                </div>
            </div>
        </section>
    </div>
        ...
        <section class="bg-img">
            <div class="isi">
                ...
                <div class="tgl-lokasi-content">
                    ...
                    <p>Pukul {{ $pesan->data->jam_acara }}</p>
                    <p class="bold">Lokasi Acara</p>
                    <p class="mb-5"><span><b>{{ $pesan->data->lokasi_acara }}</b></span>
                        <br>{{ $pesan->data ->lokasi_acara }}
                    </p>
                </div>
    ...
    <div class="konten">
        <section class="bg-img">
            <div class="isi">
                ...
                <p><span><b>{{ $pesan->data->lokasi_acara }}</b></span> <br>{{ $pesan->data->lokasi_acara }}</p>
                <a class="button-39" href="https://livejapan.com/en/spot-list/cate-cs0101005/">BUKA LOKASI</a>
            </div>
        </section>
    </div>
