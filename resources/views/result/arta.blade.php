...
<head class="center">
    ...
    <<<<<<< HEAD <title>{{ $pesan->data->nama_pasangan}} Wedding</title>
        =======
...
<body class="background-utama">
    ...
    <div class="shadow p-4 m-4 bg-body rounded" id="mempelai">
        <<<<<<< HEAD <h3 class="text-mempelai display-5 mb-4" style="font-family: 'Parisienne', cursive;" alt="mempelai"
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <form id="greetingForm">
                                    ...
                                    <div class="form-group" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-down"
                                        @endif>
                                    ...
                                    <div class="form-group" @if (in_array('Animasi',$fitur)) data-aos="zoom-in-up"
                                        @endif>
                            ...
                            <div class="card-footer text-muted">
                                <div id="senderInfo" class="sender-info" @if (in_array('Animasi',$fitur))
                                    data-aos="fade-up" @endif>
                                </div>
