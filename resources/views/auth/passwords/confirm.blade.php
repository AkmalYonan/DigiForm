    ...
    <div class="container mx-auto px-4 flex justify-center items-center relative z-10">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-slate-900 display-font">{{ __('Konfirmasi Password') }}</h1>
                <p class="text-slate-500 mt-2">{{ __('Harap konfirmasi password sebelum melanjutkan area terproteksi')
                    }}</p>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-indigo-100/50 border border-slate-100 p-8 sm:p-10">
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6" novalidate>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-slate-700 mb-2">Password Saat
                            Ini</label>
                        <div class="relative">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-check-circle mr-2 mt-1"></i> {{ __('Konfirmasi Identitas') }}
                    </button>
