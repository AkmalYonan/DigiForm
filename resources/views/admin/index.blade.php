...
<div class="container pt-5 mt-5 pb-4">
    <div class="row justify-content-center g-2">
        ...
        <div class="col-12 col-md-3">
            <div class="card bg-primary-subtle" onclick="location.href='{{ route('admin-settingPaketTemplate') }}'">
                <div class="card-body animate-dark">
        ...
        <div class="col-12 col-md-3">
            <div class="card bg-info-subtle" onclick="location.href='{{ route('admin-settingPaketFitur') }}'">
                <div class="card-body animate-dark">
